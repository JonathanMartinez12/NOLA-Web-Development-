...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'View our web development portfolio featuring Krewe of Christmas and Mendez Income Tax projects. See how we help New Orleans businesses succeed online with custom websites and SEO.',
  keywords: [
